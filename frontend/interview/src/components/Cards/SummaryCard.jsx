...
const SummaryCard = ({
  ...
  return (
    ...
    onClick={onSelect}>
        ...
        style={{background: colors?.bgcolor || '#f3f4f6'}}>
            ...
            <button className="hidden group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer absolute top-2 right-2"
            onClick={(e) => {
                e.stopPropagation();
                onDelete?.();
            }}>
